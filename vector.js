window.forbiddenPhrases = [
    ...
    "Sofía Rivera Torres", "All-stars", "americanista", "Cristiano Ronaldo", "Maratón", "Efraín Juárez", "Cowboys", "NFL",
    "Mundial 2026", "Checo Pérez", "José Ramón Fernández", "Martinoli", "Estadio", "Riquelme", "La Champions", "49ers",
    ...
    "Taylor Swift", "Bad Bunny", "Paco Stanley", "Cristian Castro", "Tom Holland", "C4Jimenez", "Martha Cristiana",
    "Dua Lipa", "Gustavo Adolfo Infante", "Ricardo Arjona", "Chespirito", "Inés Gómez Mont", "Otto Padrón",
    "Adamari López", "Pokémon", "Katy Perry", "Wendy Guevara", "Fernando Colunga", "Silvia Pinal", "Angélica Vale",
    "Pepe Aguilar", "David Faitelson", "Chumel Torres", "Fofo Márquez", "Esteban Macías", "Vanessa Guzmán",
    ...
    "Fortnite", "Xbox", "Bienestar", "Según la IA", "calidad del aire", "Remedios caseros", "té de", "receta de", "explica la ciencia",
    "masa muscular", "Hollywood", "el look que", "feminista","feminicida", "femicida", "incels", "incel", "aloe vera", "buen fin", "atole", "Atari",
    "mejorar tu salud", "ingrediente de cocina", "bajar de peso", "controlar el azúcar", "violencia doméstica", "verificación vehicular",
    ...
    "efectiva hierba", "los nutrientes", "body positive", "Mi Beca para Empezar", "femicidio", "feminicidio", "feminil", "ponche", "memes",
    "vitaminas secretas", "borrar arrugas", "rejuvenecer la piel", "dieta", "según un estudio", "remedio natural", "cine mexicano", "los científicos dicen",
